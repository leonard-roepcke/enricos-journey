...
const imagesData = [
  {
    folder: '2',
    caption: 'Sommer am See',
    description: 'Ein kurzer Abendspaziergang, aufgenommen mit dem Telefon.',
    files: ['enricos-mega.jpg'],
  },
  {
    folder: '3',
    caption: 'Restaurantabend',
    description: 'Treffen mit Freunden, Stimmung und Lichter.',
    files: ['enricos-mega.jpg'],
  },
  {
    folder: '3',
    caption: 'Straßenblick',
    description: 'Eine kurze Beobachtung der Nachbarschaft bei Sonnenuntergang.',
    files: ['enricos-mega.jpg'],
  },
  {
    folder: '4',
    caption: 'Familientreffen',
    description: 'Alte Fotos und neue Erinnerungen an einem Nachmittag.',
    files: ['enricos-mega.jpg', 'IMG-20260403-WA0001.jpg'],
  },
  {
    folder: '5',
    caption: 'Kopiertes Andenken',
    description: 'Sicherheitskopie eines besonderen Moments.',
    files: ['IMG-20260403-WA0001 copy.jpg'],
  },
  {
    folder: '6',
    caption: 'Bootcamp Demo',
    description: 'Kurzes Demo-Video kombiniert mit Fotos vom Workshop.',
    files: ['enricos-mega.jpg', 'IMG-20260405-WA0007.jpg', 'app_demo.mp4'],
  },
  {
    folder: '7',
    caption: 'App Demo Video',
    description: 'Screen recording: Prototyp-Interaktion im Überblick.',
    files: ['app_demo.mp4'],
  },
  {
    folder: '8',
    caption: 'Nachtaufnahme',
    description: 'Langzeitbelichtung und Atmosphäre bei Dämmerung.',
    files: ['PXL_20260404_045752017.MP.jpg'],
  },
];
